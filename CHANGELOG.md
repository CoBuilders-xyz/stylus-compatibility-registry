...
- Publish the beta described below, including the CLI, core library, native binaries, registry data and documentation.
...
- Installation, architecture, release and usage documentation; tag-driven CI publication.

This is an experimental beta. Scores do not certify deployment compatibility. Known compiler-output and invalid-feature fallback bugs (#35 and #45) remain open; see [limitations](docs/limitations.md). Binary size checks, automatic alternative suggestions and a web registry are not included.
